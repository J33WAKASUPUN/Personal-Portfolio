...
const AboutSection = () => {
  ...
  const stats = [
    ...
    { icon: Rocket, value: '10+', label: 'Technologies' },
    { icon: Shield, value: '100%', label: 'Commitment' },
  ];
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div 
            className={`glass-card p-8 scan-lines transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}
          >
            {/* Terminal Header */}
